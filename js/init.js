...
function createProfile(profile) {
  ...
  a3.setAttribute("onclick", "localStorage.clear(); sessionStorage.setItem('logged', 'false'), window.location.href=`login.html`");
...
document.addEventListener("DOMContentLoaded", function(e){
  if (!window.location.href.endsWith("login.html")) {
    NAVBAR.appendChild(createProfile(usuario3));
  };
});