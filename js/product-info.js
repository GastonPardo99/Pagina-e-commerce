    ...
    if (i==0) {
        htmlContentToAppendImages += `
                <div class="carousel-item active" >
                    <img src="` + productImage + `"  class="imagenesgaleria d-block w-100" >
                </div>
        ` 
     ...
     let htmlContentToAppendCarrousel = ""
        ...
        document.getElementById("car-list-container").innerHTML = htmlContentToAppend + htmlContentToAppendCarrousel;
